...
const content = {
  title: 'Кто сделал',
  text: [
    'Привет! Меня зовут Антон. Я живу в Алматы, работаю фронтенд-разработчиком, и иногда в своободное время делаю калькуляторы — в основном, для себя, потому что они удобнее и симпатичнее чем скучные таблички в Экселе.',
