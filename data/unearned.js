...
export const description = {
  title: 'Сколько вы могли заработать, если бы не смотрели сериалы',
  text: [
    'Допустим, вы посвятите работе всё время, которое уходит на просмотр сериалов. Калькулятор считает, сколько в этом случае вы могли бы заработать.',
  ],
}
